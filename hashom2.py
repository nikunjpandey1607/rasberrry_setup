...
import uuid
import Adafruit_DHT  # Standard DHT library instead of CircuitPython
...
def read_dht22():
    """Read temperature and humidity from DHT22 sensor using standard library."""
    try:
        # The read_retry method will retry up to 15 times to get a sensor reading
