...
import threading
import pigpio
from picamera2 import Picamera2  # Using picamera2 instead of OpenCV
...
picam2 = Picamera2()
camera_config = picam2.create_still_configuration(main={"size": (1024, 768)})
...
def capture_image():
    ...
    try:
        ...
        # Convert to JPEG and save to stream
...
def check_system_status(humidity_reading, water_level_reading):
    ...
    return {
        ...
        "cameraStatus": True,  # Simplified for picamera2
        "sensorStatus": {
